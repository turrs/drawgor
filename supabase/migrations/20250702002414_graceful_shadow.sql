...
DROP POLICY IF EXISTS "Anyone can view fight dragon battles" ON fight_dragon_battles;
DROP POLICY IF EXISTS "Anyone can insert fight dragon battles" ON fight_dragon_battles;
DROP POLICY IF EXISTS "Anyone can view fight dragon players" ON fight_dragon_players;
DROP POLICY IF EXISTS "Anyone can insert fight dragon players" ON fight_dragon_players;
